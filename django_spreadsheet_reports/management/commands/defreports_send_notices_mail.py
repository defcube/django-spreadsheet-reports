...
from django_spreadsheet_reports.utils import load_from_urls, send_new_notices_report
...
class Command(base.NoArgsCommand):
    ...
    def handle_noargs(self, **options):
        ...
        lock = lockfile.FileLock('/tmp/django_spreadsheet_reports_update_mail_notes')
        lock.acquire(10)
        with lock:
            load_from_urls()
            send_new_notices_report()
